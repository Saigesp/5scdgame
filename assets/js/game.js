...
var title_size = width >= 600 ? "7.1rem" : width / 4.2 + "px",
...
d3.json("assets/data/graph3.json", function(error, graph) {
        ...
        if (atracted) {
            ...
            if (alredy_pos < 0) {
                ...
                switch (rect_array.length) {
                    case 1:
                        claim.text('Bien, bien, ese es el camino');
                        break;
                    case 2:
                        claim.text('Uno menos!');
                        break;
                    case 3:
                        claim.text('Olé');
                        break;
                    case 4:
                        claim.text('Vamos, no pares!');
                        break;
                    case 5:
                        claim.text('No pienses, actúa!');
                        break;
                    case 6:
                        claim.text('Ya casi lo tienes!');
                        break;
                    case 7:
                        claim.text('Un poco más!');
                        break;
                    case 8:
                        claim.text('Vamosss!!!');
                        break;
                    case 9:
                        claim.text("Where is your god now?");
                        update();
                        break;
                }
